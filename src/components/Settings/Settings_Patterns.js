    ...
    const handleSave = async (e) => {
        ...
        if (patternsToChange !== undefined &&
            ...
            for (let i = 0; i < patternsToChange.length; i++) {
                if (patterns[patternsToChange[i]].Duration === undefined
        ...
        <>
            {
                loading
                    ...
                    : <div className='SettingsArray'>
                        {
                            patterns.map((shift, index) => <div key={index} className='SettingsRow'>
                                <TextField
                                    className='ShiftName'
                                    value={shift.Name}
                        ...
                        <button className='MyButton' disabled={
                            patternsToChange === undefined || patternsToChange === null || patternsToChange.length <= 0
                        }
